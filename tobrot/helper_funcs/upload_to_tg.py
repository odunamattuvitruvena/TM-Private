    ...
    if os.path.isdir(local_file_name):
        ...
        if not message.photo:
            new_m_esg = await message.reply_text(
                "𝗙𝗼𝘂𝗻𝗱 {} 𝗳𝗶𝗹𝗲𝘀".format(len(directory_contents)),
                quote=True
        ...
        if os.path.getsize(local_file_name) > TG_MAX_FILE_SIZE:
            ...
            i_m_s_g = await message.reply_text(
                "𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗱𝗼𝗲𝘀 𝗻𝗼𝘁 𝘀𝘂𝗽𝗽𝗼𝗿𝘁 𝗨𝗽𝗹𝗼𝗮𝗱𝗶𝗻𝗴 𝗠𝗼𝗿𝗲 𝗧𝗵𝗲𝗻 𝟮𝗚𝗕\n"
                f"𝗗𝗲𝘁𝗲𝗰𝘁𝗲𝗱 𝗙𝗶𝗹𝗲 𝗦𝗶𝘇𝗲: {d_f_s} 😡\n"
                "\n🤖 𝘁𝗿𝘆𝗶𝗻𝗴 𝘁𝗼 𝘀𝗽𝗹𝗶𝘁 𝘁𝗵𝗲 𝗳𝗶𝗹𝗲𝘀 🌝🌝🌚"
            )
            ...
            await i_m_s_g.edit_text(
                f"𝗗𝗲𝘁𝗲𝗰𝘁𝗲𝗱 𝗙𝗶𝗹𝗲 𝗦𝗶𝘇𝗲: {d_f_s} 😡\n"
                f"<code>{ba_se_file_name}</code> 𝗗𝗶𝘃𝗶𝗱𝗲𝘀 𝗶𝗻𝘁𝗼 {number_of_files} files.\n"
                "𝗧𝗿𝘆𝗶𝗻𝗴 𝟮 𝗨𝗽𝗹𝗼𝗮𝗱 𝟮 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺, 𝗻𝗼𝘄 ..."
            )
...
async def upload_to_gdrive(file_upload, message, messa_ge, g_id):
    ...
    del_it = await message.edit_text("🔊 𝐍𝐨𝐰 𝐔𝐩𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐭𝐨 ☁️ 𝐂𝐥𝐨𝐮𝐝!!!")
    ...
    if os.path.isfile(file_upload):
        ...
        LOGGER.info(gjay)
        button = []
        button.append([pyrogram.InlineKeyboardButton(text="☁️ 𝗖𝗹𝗼𝘂𝗱𝗨𝗿𝗹 ☁️", url=f"{gau_link}")])
        if INDEX_LINK:
            indexurl = f"{INDEX_LINK}/{file_upload}"
            tam_link = requests.utils.requote_uri(indexurl)
        ...
        await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
        await messa_ge.reply_text(f"🤖: {file_upload} 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗨𝗽𝗹𝗼𝗮𝗱𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝘁𝗼 𝘆𝗼𝘂𝗿 𝗖𝗹𝗼𝘂𝗱 <a href='tg://user?id={g_id}'>🤒</a>\n📀 Size: {gjay}", reply_markup=button_markup)
        ...
        button_markup = pyrogram.InlineKeyboardMarkup(button)
        await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
        await messa_ge.reply_text(f"🤖: 𝗙𝗼𝗹𝗱𝗲𝗿 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗨𝗽𝗹𝗼𝗮𝗱𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝘁𝗼 {tt} 𝗶𝗻 𝘆𝗼𝘂𝗿 𝗖𝗹𝗼𝘂𝗱 <a href='tg://user?id={g_id}'>🤒</a>\n📀 Size: {gjay}", reply_markup=button_markup)
        #await asyncio.sleep(EDIT_SLEEP_TIME_OUT)
        #await messa_ge.reply_text(f"""🤖: 𝗙𝗼𝗹𝗱𝗲𝗿 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗨𝗽𝗹𝗼𝗮𝗱𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝘁𝗼 {tt} 𝗶𝗻 𝘆𝗼𝘂𝗿 𝗖𝗹𝗼𝘂𝗱 🤒\n\n☁️ Cloud URL:  <a href="{gau_link}">FolderLink</a>\nℹ️ Index Url:. <a href="{tam_link}">IndexLink</a>""")
...
async def upload_single_file(message, local_file_name, caption_str, from_user, edit_media):
    ...
    try:
        ...
        if local_file_name.upper().endswith(("ABC")):
